...
本次纳新任务截止提交时间：2023.3.24 23:59 GMT+08:00
...
可能有部分内容需要更长时间的学习了解才能掌握，不必担心**我们对不完整的代码也会进行考量评价**，请尽你所能的完成你所选择任务（你也可以简述你的设计思路来替代一部分你来不及完成的功能）

不要因为不了解的内容过多而产生畏惧，相比起成果我们更看重**实践过程中的思路**和**最终的代码质量**
